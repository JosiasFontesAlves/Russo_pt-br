export default {
    A: {
        ...
        alegremente: 'всело', além: 'дальше', Alemanha: 'Германия', algo: 'что-нибудь', ali: 'там', alimentar: 'кормить', aluno: 'ученик', amarelo: 'жёлтый',
        amigo: 'друг', amizade: 'дружба', aparecer: 'появиться', aprender: 'учить', aquele: 'тот', aqui: 'тут/здесь', arremessar: 'бросить', arroz: 'рис',
    ...
    C: {
        ...
        certo: 'правильный', cerveja: 'пиво', chá: 'чай', chamada: 'вызов', chamar: 'звать', chatear: 'наскучить', chorar: 'плакать',
        ...
        conseguir: 'достичь', congelar: 'замерзнуть', considerar: 'рассмотреть', consumidor: 'покупатель', conta: 'счёт',
    ...
    G: {
        ganhar: 'выиграть', garçom: 'официант', garçonete: 'официантка', garfo: 'вилка', garganta: 'горло/глотка', garrafa: 'бутылка', garota: 'девочка ',
        garoto: 'мальчик ', gênio: 'гений', genitor: 'родитель', gordo: 'толстый', gorro: 'шапка', gostar: 'нравится', grande: 'большой', gramado: 'газон',
        gravata: 'галстук', grito: 'крик', 'guarda-chuva': 'зонт',
    },
    H: {
    ...
    V: {
        ...
        'vermelho escuro': 'тёмно-красный', vestido: 'платье', vestir: 'надевать', vinho: 'вино', visão: 'зрение', 'video game': 'видеоигра',
        vinte: 'двадцать', você: 'вы', votar: 'голосовать',
    },
    X: {
        xícara: 'чашка',
    },
