...
export const dicionário = {
    A: {
        ...
        agradecer: 'благодарить', água: 'вода', alcançar: 'достать / доставать', alegrar: 'радовать', alegremente: 'весело', além: 'дальше',
        alimentar: 'кормить', amizade: 'дружба', aparecer: 'появиться', arremessar: 'бросить', arroz: 'рис',
    },
    B: {
        balançar: 'качать', banheiro: 'ванная комната', banquisa: 'льдина', barba: 'борода', barco: 'корабль ', bastante: 'достаточно', batata: 'картошка',
        bebê: 'Младенец', beber: 'пить', bem: 'хорошо', buraco: 'дырка', buscar: 'искать',
    },
    C: {
    ...
    D: {
        ...
        domingo: 'воскресенье', durante: 'в течение',
    },
    E: {
    ...
    G: {
        garganta: 'горло/глотка', gênio: 'гений', gramado: 'газон', grito: 'крик',
    },
    H: {
        homem: 'мужчина', hora: 'час', hospital: 'больница',
    },
    I: {
        imaginação: 'воображение', insanamente: 'безумно', injusto: 'нечестный', irmãos: 'братья', irritado: 'злой', irritar: 'бесить',
    },
    J: {
        janeiro: 'январь', joelho: 'Колень', junho: 'июнь', julho: 'июль',
    },
    L: {
        laranja: 'апельсин', legume: 'овощ', lembrar: 'вспоминать', levantar: 'вставать', ligar: 'включать', limão: 'лимон',
    },
    M: {
        macarrão: 'макароны', maçã: 'яблоко', maio: 'май', março: 'март', matar: 'убить', melhorar: 'поправиться', merda: 'гавно (adj)', mexer: 'двигаться',
    ...
    R: {
        ...
        relatório: 'доклад', reserva: 'бронирование', reservar: 'бронировать', respeitar: 'уважать', rodoviária: 'Автовокзал', roubar: 'украсть',
    },
    S: {
